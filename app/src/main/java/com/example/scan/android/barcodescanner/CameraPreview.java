package com.example.scan.android.barcodescanner;
...
import com.example.scan.android.barcodescanner.camera.CameraInstance;
import com.example.scan.android.barcodescanner.camera.CameraParametersCallback;
import com.example.scan.android.barcodescanner.camera.CameraSettings;
import com.example.scan.android.barcodescanner.camera.CameraSurface;
import com.example.scan.android.barcodescanner.camera.CenterCropStrategy;
import com.example.scan.android.barcodescanner.camera.DisplayConfiguration;
import com.example.scan.android.barcodescanner.camera.FitCenterStrategy;
import com.example.scan.android.barcodescanner.camera.FitXYStrategy;
import com.example.scan.android.barcodescanner.camera.PreviewScalingStrategy;
...
public class CameraPreview extends ViewGroup {
    ...
    private void calculateFrames() {
        ...
        Log.e("CameraPreview", "containerSize.width=" + containerSize.width);
        Log.e("CameraPreview", "containerSize.height=" + containerSize.height);
//        DisplayMetrics metrics = c.getResources().getDisplayMetrics();
//        metrics.heightPixels;
        //modify:修改扫描焦点矩形的坐标
        Rect container = null;
        if (custom) {
            container = new Rect(0, 0, width, height * 23 / 100);
        } else {
