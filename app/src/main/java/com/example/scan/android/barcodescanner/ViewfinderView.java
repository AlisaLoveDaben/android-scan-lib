...
public class ViewfinderView extends View {
    ...
    protected float zxing_marginTop;
    //判断距上距离是否已经添加到控件上
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        this.zxing_marginTop = attributes.getDimension(R.styleable.zxing_finder_zxing_margintop,0);
    ...
    protected void refreshSizes() {
        ...
        if(framingRect != null && previewFramingRect != null) {
            ...
            if(!isTop){
                this.framingRect.top += zxing_marginTop;
                this.framingRect.bottom += zxing_marginTop;
                this.previewFramingRect.top += zxing_marginTop;
                this.previewFramingRect.bottom += zxing_marginTop;
                isTop = true;
            }
        }
    }
