...
import com.example.scan.android.BeepManager;
import com.example.scan.android.InactivityTimer;
import com.example.scan.android.Intents;
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    if (needFinish) {
                        ...
                        intent.setAction("com.ctirobot.scan.result");
                        //发送一个广播
...
//            displayFrameworkBugMessageAndExit();
            Log.e(TAG, "CameraPreview Error; error="+error.getLocalizedMessage());
        }
